...
public class RestApiController {
	...
	// POST 방식
	@Operation(summary = "postTest", description = "POST METHOD TEST", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Test 객체를 담은 파라미터", content = @Content(examples = {
			@ExampleObject(name = "Test Model", value = """
					    {
					      "idx" : "1",
					      "col1" : "a",
					      "col2" : "b"
	...
	public Response<Integer> postTest(
			@RequestBody(required = true) Request<Test> req) {
	...
	public Response<Integer> deleteTest(@RequestParam(value = "idx", required = false) Integer idx, // int는 null 허용 X
			@RequestParam(value = "col1", defaultValue = "") String col1,
			@RequestParam(value = "col2", defaultValue = "") String col2) {
