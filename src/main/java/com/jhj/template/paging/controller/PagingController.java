package com.jhj.template.paging.controller;
...
import com.jhj.template.common.utils.JsonUtils;
import com.jhj.template.common.utils.PagingSet;
import com.jhj.template.paging.model.PageInfo;
import com.jhj.template.paging.service.PagingService;
...
public class PagingController {
    ...
    public Response<PageInfo<Test>> pagingTest(
        ...
        try {
            ...
            if (isExcel.equalsIgnoreCase("Y")) {
                ...
                if (resDataCnt.get(0).getClass().getSimpleName().equals("HashMap")) {
                    TotalDataCnt tdc =
                            JsonUtils.getObjectToClass(resDataCnt.get(0), TotalDataCnt.class);
                    resDataCnt.set(0, tdc);
                }

                HashMap<String, Object> pageParams =
                        PagingSet.setPageParams(param, pageNum, rowsPerPage, maxRows, resDataCnt);
