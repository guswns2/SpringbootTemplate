package com.jhj.template.common.utils;
...
public class JsonUtils {
    ...
    public static String getJsonFromObject2(Object obj) {
        ...
        /*
         * Gson에서는 JsonIgnoreProperties / JsonIgnore 안됨 transient는 객체를 직렬화(Serialize) 할 때, 특정 필드를
         * 제외하고 싶을 때 사용합니다.
         * 
         * 제외하려고 하는 필드에 transient를 붙이면,
         * 
         * 해당 필드를 제외하고 Json 문자열이 생성됩니다. 출처: https://hianna.tistory.com/629 [어제 오늘 내일]
         */
        /*
         * Gson gson = new GsonBuilder().create(); String jsonString = null;
         * 
         * try { jsonString = gson.toJson(obj); } catch (Exception e) { log.error(e.getMessage(),
         * e); }
         * 
         * return jsonString;
         */
    ...
    public static HashMap<String, Object> getHashMap(Object obj) {
        ...
        HashMap<String, Object> hashMap =
                objectMapper.convertValue(obj, new TypeReference<HashMap<String, Object>>() {});
