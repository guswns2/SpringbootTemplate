...
public class PagingSet {
    ...
    // 페이징 파라미터 설정
    public static <T> HashMap<String, Object> setPageParams(HashMap<String, Object> param,
            int pageNum, int rowsPerPage, int maxRows, List<T> totalDataCnt) {
    ...
    // 페이징 결과
    public static <T> Response<PageInfo<T>> setResDataPage(Boolean isSucc, int pageNum,
            int rowsPerPage, int totalDataCnt, List<T> dataList) {
